          ...
          <div className="text-white w-1/2">
            <div className="max-w-[320px] space-y-5">
              <h4 className="text-base font-semibold">
                {import.meta.env.VITE_SITE_NAME} | দক্ষিণ এশিয়ায় বিশ্বস্ত অনলাইন ক্যাসিনো | বাংলাদেশ,
                ভারত, নেপালে শুধুমাত্র
              </h4>
              <p className="text-sm">
                {import.meta.env.VITE_SITE_NAME} হল একটি অনলাইন ব্যাটিং কোম্পানি, যা বিস্তৃত পরিসরে বাজি
