...
import LoadingImageUploadForm from "./LoadingImageUploadForm";
    ...
    <>
      <div>
        <div className="bg-[#222222] flex flex-row items-start justify-between w-full p-4 mb-2">
          <p className="text-2xl text-white font-bold">Upload Loading Image</p>
          <Button
      ...
      <Modal
        title={"Uplaod loading image"}
        isOpen={isModalOpen}
        onOpenChange={() => setIsModalOpen(false)}
      >
        <LoadingImageUploadForm closeModal={() => setIsModalOpen(false)} />
      </Modal>
    </>
  );
};
