...
const StatCard = ({ title, value, icon, themeColor, onClick }) => (
  <div onClick={onClick} className="col-6 md:col-3 p-2 flex justify-center">
    <div
      style={{ backgroundImage: `linear-gradient(to right, #333, ${themeColor})` }}
...
export default function DashboardHome() {
  ...
  const statsDataForUserRow = [
    { title: 'Total User', value: dashboardData.totalUsers, icon: <FaUsers />, route: '/dashboard/all-user', themeColor: '#b81e2d' },
    { title: 'Total Affiliator', value: dashboardData.totalAffiliator, icon: <FaUserFriends />, route: '/', themeColor: '#b81e2d' },
    { title: 'Total Wallet Agent', value: dashboardData.totalWalletAgent, icon: <FaUserCheck />, route: '/', themeColor: '#b81e2d' },
    { title: 'Total White Label', value: dashboardData.totalWhiteLabel, icon: <FaShieldAlt />, route: '/', themeColor: '#b81e2d' },
  ];

  const statsDataForGameRow = [
    { title: 'Total Game', value: dashboardData.totalGames, icon: <FaGamepad />, route: '/dashboard/game-categories', themeColor: '#45f82a' },
    { title: 'Active Game', value: dashboardData.activeGame, icon: <FaPlay />, route: '/dashboard/active-games', themeColor: '#45f82a' },
    { title: 'Inactive Game',  value: dashboardData.inactiveGame, icon: <FaStop />, route: '/', themeColor: '#45f82a' },
    { title: 'Total Game API', value: dashboardData.totalGameApi, icon: <FaRobot />, route: '/', themeColor: '#45f82a' },
  ];

  const statsDataForMoneyRow = [
    { title: 'Total Deposit', value: dashboardData.totalDeposit, icon: <FaMoneyCheck />, route: '/dashboard/DepositHistory', themeColor: '#010fe5' },
    { title: 'Today Deposit', value: dashboardData.todayDeposit, icon: <FaMoneyCheckAlt />, route: '/dashboard/DepositHistory', themeColor: '#010fe5' },
    { title: 'Total Withdraw', value: dashboardData.totalWithdraw, icon: <FaMoneyBill />, route: '/dashboard/WithdrawalHistory', themeColor: '#010fe5' },
    { title: 'Today Withdraw', value: dashboardData.todayWithdraw, icon: <FaMoneyBillWave />, route: '/dashboard/WithdrawalHistory', themeColor: '#010fe5' },
  ];

  const statsDataForPendingDepositRequestRow = [
    { title: 'Deposit Request', value: dashboardData.pendingDepositRequests, icon: <FaClock />, route: '/dashboard/DepositHistory', themeColor: '#e91e63' },
    { title: 'Withdraw Request', value: dashboardData.pendingWithdrawRequests, icon: <FaHourglass />, route: '/dashboard/WithdrawalHistory', themeColor: '#e91e63' },
    { title: 'Affiliate Signup Request', value: dashboardData.affiliateSignupRequest, icon: <FaUserPlus />, route: '/', themeColor: '#e91e63' },
    { title: 'Wallet Agent Signup Request', value: dashboardData.walletAgentSignupRequest, icon: <FaUserFriends />, route: '/', themeColor: '#e91e63' },
  ];
